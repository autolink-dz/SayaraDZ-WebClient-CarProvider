            ...
            <div className={classes.container}>
                <Grid container spacing={24}>
                    ...
                    <ShowModele
                        ...
                        code={this.state.code} nom={this.state.nom} url={this.state.url} options={this.state.options}
        ...
        return (
            <Grid item xs={12}>
                <div className={classes.root}>
                    ...
                    {snack}
                    <CircularProgress className={classes.place}
                                      style={this.props.loading ? {display: 'none'} : stProgresse}/>
                    {
                        this._renderItems()
                    }
                    {this._renderWaypoint()}
                    <CircularProgress
                        style={this.props.next == null || this.props.next === 0 ? {display: 'none'} : {marginLeft: '48%'}}/>
                </div>
            </Grid>
        );
    }
