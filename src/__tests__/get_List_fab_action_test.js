...
describe("add fab action", () => {
    ...
    it("dispatches getFabsList action and get END_GET_FABS type dispatched", async () => {
        jest.mock('axios');
     let id_marque = "snXVki6wfhpJchYGV7X7"
        ...
        await store.dispatch(getFabsList(id_marque));
